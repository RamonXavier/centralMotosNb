...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <a class="navbar-brand" href="./inicio.php">Central Motos NB</a>
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="relatorioEmpregadosDepto.php">Qtde Empregados por
                            Departamento</a>
                        <div class="dropdown-divider"></div>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="cadastroDepartamento.php">Bairros</a>
                        <div class="dropdown-divider"></div>
