...
if (
    ...
    || isset($_POST['formPost']) && $_POST['formPost']  == 'formFilter_relatorioPedido' //condição 4 -  formulário filtro rel. pedido
) {
...
if (isset($_POST['formPost']) == true && $_POST['formPost']  == 'formFilter_relatorioPedido') {
    $relatorioDAO = new \App\DAO\RelatorioDAO();
